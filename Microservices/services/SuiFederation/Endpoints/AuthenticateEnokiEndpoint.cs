...
public class AuthenticateEnokiEndpoint : IEndpoint
{
    ...
    public async Promise<FederatedAuthenticationResponse> Authenticate(string token, string challenge, string solution)
    {
        ...
        {
            var microserviceInfo = MicroserviceMetadataExtensions.GetMetadata<SuiFederation, SuiEnokiIdentity>();
        ...
        {
            var addressData = await provider.Resolve(_requestContext.UserId, challenge, solution);

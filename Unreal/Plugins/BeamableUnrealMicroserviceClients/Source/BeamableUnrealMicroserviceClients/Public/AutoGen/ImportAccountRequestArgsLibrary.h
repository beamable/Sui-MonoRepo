...
#include "BeamableUnrealMicroserviceClients/Public/AutoGen/ImportAccountRequestArgs.h"

#include "ImportAccountRequestArgsLibrary.generated.h"


UCLASS(BlueprintType, Category="Beam")
class BEAMABLEUNREALMICROSERVICECLIENTS_API UImportAccountRequestArgsLibrary : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()

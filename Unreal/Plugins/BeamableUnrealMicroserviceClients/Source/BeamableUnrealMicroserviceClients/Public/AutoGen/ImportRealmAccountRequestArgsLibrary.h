...
#include "BeamableUnrealMicroserviceClients/Public/AutoGen/ImportRealmAccountRequestArgs.h"

#include "ImportRealmAccountRequestArgsLibrary.generated.h"


UCLASS(BlueprintType, Category="Beam")
class BEAMABLEUNREALMICROSERVICECLIENTS_API UImportRealmAccountRequestArgsLibrary : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()

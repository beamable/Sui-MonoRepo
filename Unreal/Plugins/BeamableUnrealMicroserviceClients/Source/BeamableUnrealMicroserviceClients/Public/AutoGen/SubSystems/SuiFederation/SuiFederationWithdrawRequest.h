...
#include "BeamableUnrealMicroserviceClients/Public/AutoGen/WithdrawRequestArgs.h"
#include "Serialization/BeamPlainTextResponseBody.h"

#include "SuiFederationWithdrawRequest.generated.h"

UCLASS(BlueprintType)
class BEAMABLEUNREALMICROSERVICECLIENTS_API USuiFederationWithdrawRequest : public UObject, public IBeamBaseRequestInterface
{
	GENERATED_BODY()
